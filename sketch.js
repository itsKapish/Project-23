...
function preload()
{
	...
	//packageBodyImg=loadImage("png-transparent-package-delivery-mail-box-parcel-box-thumbnail.png");
}
...
function setup() {
	...
	packageSprite.shapeColor = "red";
	//packageSprite.addImg(packageBodyImg) Pls note that I tried to make a Package.png but it is not working, pls help.
